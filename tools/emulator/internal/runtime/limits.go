...
var limitedFuncs = map[string]limitedFunc{
	...
	"getRoleID":              {limits: []callLimit{limitAPI}},
	"getRoleName":            {limits: []callLimit{limitAPI}},
	"addRoleName":            {limits: []callLimit{limitAPI}},
	"removeRoleName":         {limits: []callLimit{limitAPI}},
	"targetHasRoleName":      {limits: []callLimit{limitAPI}},
